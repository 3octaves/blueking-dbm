      ...
      <div
        ...
        <div class="content-item">
          ...
          <div class="item-content">
            ...
            <ValueDiff
              :current-value="activeRowData.machinePair"
              :show-rate="false"
        ...
        <div class="content-item">
          ...
          <div class="item-content">
            ...
            <ValueDiff
              :current-value="activeRowData.machineCount"
              :show-rate="false"
...
<script setup lang="ts">
  ...
  const isOriginal = defineModel<boolean>('is-original', {
    default: true,
  });
  ...
  const handleClickSelect = () => {
    ...
    if (rowData && rowData.targetCluster) {
      ...
      const obj = {
        ...
        machinePair: rowData.machinePair,
        machineCount: rowData.machineCount,
      };
  ...
  const handleChoosedTargetCapacity = (obj: ClusterSpecModel, capacity: CapacityNeed, targetInfo: TargetInfo) => {
    ...
    isOriginal.value = targetInfo.methed === 'original';
