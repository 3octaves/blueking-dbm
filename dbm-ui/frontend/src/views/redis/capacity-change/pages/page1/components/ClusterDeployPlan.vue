    ...
    <div class="main-box">
      <div class="capacity-panel">
        ...
        <div class="panel-row mt-4">
          ...
          <div class="row-column">
            <div class="column-title">{{ t('目标规格') }}：</div>
            <div class="column-content">
        ...
        <div class="panel-row mt-4">
          <div class="row-column">
            ...
            <div class="column-content">
              <span class="number-style">{{ data?.machinePair }}</span>
            </div>
          </div>
          <div class="row-column">
            ...
            <div class="column-content">
              <span v-if="targetInfo.spec.name">
                <span class="number-style">{{ targetInfo.machinePair }}</span>
                <ValueDiff
                  :current-value="data.machinePair"
                  :show-rate="false"
                  :target-value="targetInfo.machinePair" />
              </span>
              <span
                v-else
                style="color: #c4c6cc">
        ...
        <div class="panel-row panel-row mt-4">
          <div class="row-column">
            ...
            <div class="column-content">
              <span class="number-style">{{ data?.machineCount }}</span>
            </div>
          </div>
          <div class="row-column">
            ...
            <div class="column-content">
              <span v-if="targetInfo.spec.name">
                <span class="number-style">{{ targetInfo.machineCount }}</span>
                <ValueDiff
                  :current-value="data.machineCount"
                  :show-rate="false"
                  :target-value="targetInfo.machineCount" />
              </span>
              <span
                v-else
                style="color: #c4c6cc">
