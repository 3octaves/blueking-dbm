...
<script setup lang="ts">
  ...
  import RandomFixed from './content-item/RandomFixed.vue';
  import RandomSelectableOrMultiple from './content-item/RandomSelectableOrMultiple.vue';
  import RandomSelectableOrSingle from './content-item/RandomSelectableOrSingle.vue';
