  ...
  <div class="victoriametrics-query-list-page">
    <div class="operation-box">
      ...
      <DropdownExportExcel
        ...
        :ids="selectedIdList"
        :type="ClusterTypes.K8S_VICTORIAMETRICS_QUERY" />
      <DbQuickSearch
        v-model="searchValue"
        class="quick-search"
    ...
    <ClusterTable
      ...
      <template #operation>
        <OperationColumn :cluster-type="ClusterTypes.K8S_VICTORIAMETRICS_QUERY">
...
<script setup lang="ts">
  ...
  const { t } = useI18n();
  const { isSearching, quickSearchData, searchValue } = useClusterQuickSearch(ClusterTypes.K8S_VICTORIAMETRICS_QUERY);
