...
<script setup lang="ts" generic="T extends IValue">
  ...
  import { getTendbhaFlatList as getTendbhaList } from '@services/source/tendbha';
  import { getTendbsingleFlatList as getTendbsingleList } from '@services/source/tendbsingle';
