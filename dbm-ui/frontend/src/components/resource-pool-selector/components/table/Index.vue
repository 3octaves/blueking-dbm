...
<script setup lang="tsx">
  ...
  const isIndeterminate = computed(() => !isSelectedAll.value && Object.keys(checkedMap).length > 0);
  ...
  watch(() => props.lastValues, () => {
    ...
    checkedMap.value = props.lastValues.reduce<Record<string, DbResourceModel>>((prevCheckedMap, item) => Object.assign({}, prevCheckedMap, {
