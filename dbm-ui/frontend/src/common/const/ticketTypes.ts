...
export enum TicketTypes {
  ...
  MYSQL_SINGLE_DB_TABLE_BACKUP = 'MYSQL_SINGLE_DB_TABLE_BACKUP',
  ...
  MYSQL_SINGLE_FLASHBACK = 'MYSQL_SINGLE_FLASHBACK',
  ...
  MYSQL_SINGLE_FULL_BACKUP = 'MYSQL_SINGLE_FULL_BACKUP',
