...
import type { DbStruct } from '@services/model/ticket/details/mongo';
...
// MongoDB 定点构造
export async function generateRestoreCloneData(ticketData: TicketModel<DbStruct>) {
  const {
    cluster_type: clusterType,
    resource_spec: spec,
    instance_per_host: instancePerHost,
    ns_filter: nsFilter,
  } = ticketData.details;
  ...
  return {
    clusterType,
    specId: spec.mongodb.spec_id,
    shardNum: instancePerHost,
    nsFilter,
